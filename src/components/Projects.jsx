  ...
  const projects = [
    {
      ...
      description: 'Multi-role software ecosystem for SaaS, POS, and eCommerce platforms. Implemented real-time communication with Socket.IO and optimized database performance with TypeORM.',
    ...
    },
    {
      ...
      description: 'Developed scalable APIs and automated workflows using Node.js, Redis, and RabbitMQ. Focused on empowering youth with digital tools and resources for entrepreneurship.',
      image: '/future-nation.jpg',
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {filteredProjects.map((project, index) => (
            <div
              key={index}
              className="group card overflow-hidden hover:translate-y-[-4px] transition-all duration-300"
            >
              {/* Project Image */}
                ...
                <div className="absolute bottom-4 left-4 right-4 text-white">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.technologies.slice(0, 3).map((tech) => (
                      <span
                        key={tech}
                        className="text-sm px-2 py-1 rounded-full bg-white/20 backdrop-blur-sm"
                      >
                        {tech}
                      </span>
                    ))}
                    {project.technologies.length > 3 && (
                      <span className="text-sm px-2 py-1 rounded-full bg-white/20 backdrop-blur-sm">
