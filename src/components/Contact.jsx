...
const Contact = () => {
    ...
    const contactInfo = [
        ...
        },
        {
            ...
            socials: [
                { name: 'GitHub', url: 'https://github.com/ansarali41', icon: 'github' },
                { name: 'LinkedIn', url: 'https://www.linkedin.com/in/dev-ansar-ali', icon: 'linkedin' },
                        ...
                        {contactInfo.map((info, index) => (
                            <div key={index} className="card p-6 hover:translate-y-[-4px] transition-all duration-300">
                                <div className="flex items-start gap-4">
                                    <div className="rounded-lg bg-gray-100 dark:bg-gray-800 p-3">{info.icon}</div>
                                    <div>
